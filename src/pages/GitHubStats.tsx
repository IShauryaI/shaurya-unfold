...
const GitHubStats = () => {
  ...
  const StatCard = ({ 
    ...
    <div className="card-elevated flex items-center justify-center p-4 min-h-[180px]">
      ...
      {errorStates[loadingKey] ? (
        ...
        <img 
          src={src}
          alt={alt}
          className={`w-full h-auto transition-opacity duration-300 ${loadingStates[loadingKey] ? 'opacity-0' : 'opacity-100'}`}
          loading="lazy"
